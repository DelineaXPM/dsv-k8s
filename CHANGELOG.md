...
Update kubernetes packages dependencies.

| Package                                                             | Type    | Update | Change                      |
| ------------------------------------------------------------------- | ------- | ------ | --------------------------- |
| [k8s.io/api](https://togithub.com/kubernetes/api)                   | require | patch  | `v0.25.0` -> `v0.25.2`      |
| [k8s.io/apimachinery](https://togithub.com/kubernetes/apimachinery) | require | patch  | `v0.25.0` -> `v0.25.1-rc.0` |
| [k8s.io/client-go](https://togithub.com/kubernetes/client-go)       | require | patch  | `v0.25.0` -> `v0.25.2`      |

The below vulnerabilities will be automatically resolved:
...
| ----------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------- |
| ![Medium](https://whitesource-resources.whitesourcesoftware.com/medium_vul_bb.png) Medium | 5.1                                                                                                                       | [CVE-2022-3172](https://vuln.whitesourcesoftware.com/vulnerability/CVE-2022-3172) |
